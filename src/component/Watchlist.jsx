...
const Watchlist = () => {
  const {watchlist,deleteWatchlist,handleAlreadyWatched,allreadyWatched}=useContext(GlobalContext);
    ...
    <div>
      ...
      <div className='m-10 '>
        <p className='text-[28px] font-medium '> My WatchList</p>
         <ul className='grid grid-cols-5 gap-10  mt-7'>
        {
            ...
            return(
              <li key={item.id}>
                ...
                <div className='flex gap-2 items-end my-4'>
                  <button className='bg-green-800 w-[90px] p-1 rounded-md text-white ' onClick={()=>handleAlreadyWatched(item.id)}>Watch</button>
